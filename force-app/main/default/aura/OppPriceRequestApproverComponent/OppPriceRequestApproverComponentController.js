({
    init : function(component, event, helper) {
        ...
        helper.getPermissionsAjax(component).then(function(permissions){
            component.set("v.isActive", permissions.isEnabled);
            component.set("v.approverMode", permissions.isStoreApprover);
            component.set("v.isStoreManager", permissions.isStoreManager);
            component.set("v.isFactoryManager", permissions.isFactoryManager);
            component.set("v.isStoreApprover", permissions.isStoreApprover);
            component.set("v.isFactoryApprover", permissions.isFactoryApprover);
            ...
            } else if (permissions.isFactoryApprover == false && permissions.isStoreApprover == false) {
                /* Not an approver */
                component.set("v.showPage", true);
    ...
    handleRowAction: function (component, event, helper) {
        ...
        switch (action.name) {
            ...
            case 'ask_factory':
                component.set("v.selectedPriceRequest", row.OpportunityId);
                var modal = component.find('modalPriceRequestFactory');
                var backdrop = component.find('backdropId');
                $A.util.toggleClass(modal, 'slds-fade-in-open');
                $A.util.toggleClass(backdrop, 'slds-backdrop_open');
                break;
