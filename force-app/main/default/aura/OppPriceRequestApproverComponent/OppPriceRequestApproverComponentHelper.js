({
    ...
    setColumns : function(component) {
        var isFactoryApprover = component.get("v.isFactoryApprover");
        var isStoreApprover = component.get("v.isStoreApprover");
        var listColumns = [];
        listColumns = [
            ...
            {type: "button", sortable: false, fixedWidth: 140, typeAttributes: { label: 'Store', name: 'store', title: 'Store', disabled: false, value: 'store'}},
            //{type: "button", sortable: false, fixedWidth: 140, typeAttributes: { label: 'Factory', name: 'ask_factory', title: 'Factory', disabled: false, value: 'ask_factory'}},
        ]
    ...
    getHeadersListAjax : function(component) {
        var action = component.get("c.getHeadersList");
        return this.returnPromiseAjax(action);
    },
    getHeadersHistoricListAjax : function(component) {
        var action = component.get("c.getHistoricHeadersList");
        return this.returnPromiseAjax(action);
    },
