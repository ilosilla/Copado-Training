({
	setColumns : function(component) {
        var columns = [
            ...
            {label: $A.get('$Label.c.prequest_price_needed'), fieldName: 'FactoryPriceNeeded__c', type: 'text'},
            {label: $A.get('$Label.c.prequest_approved_price'), fieldName: 'FactoryApprovedPrice__c', type: 'text'}
        	];
        ...
        columns.push({label: $A.get('$Label.c.dict_status'), fieldName: 'FactoryStatus__c', type: 'text'});
