({
     ...
     */
     readFacadeData : function(component, opportunityId, facadeId) {       
        component.set("v.showSpinner", true);
        var action = component.get("c.readFacadeData");
        action.setParams({
            opportunityId : opportunityId,
            facadeId : facadeId
        });            
        action.setCallback(this, response => this.readFacadeDataCallback(component, response));
        $A.enqueueAction(action);                    
    }, // readCustomProjectData

    readFacadeDataCallback : function(component, response) { 
  ...
  /**
    ...
    afterUploadFile : function (component, contentIds, contentType) {
        var pid = component.get("v.facadeId");
    ...
    setupScreen : function(component) {
       this.setCurrencyFields(component);
        var manager = component.find("Manager__c").get("v.value");        
        ...
        this.setStageFields(component);
    },

    dataSaved : function(component) {
        component.set("v.isActive", false);
        component.set("v.showSpinner", false);
        var createMode = component.get("v.createMode");
        var action = "MODIFY";
        ...
        this.fireComponentEvent(component, action, component.get("v.facadeId"));                        
    },
    ...
    setManagers : function(component, managerId) {    
        ...
        console.log('Default manager: ' + defaultOption);
        component.set('v.managers', options);
        component.set("v.manager", defaultOption);
    ...
    setStageFields : function(component) {
        var stage = component.find("Stage__c").get("v.value");
        component.set("v.isSoldAndShipping", (stage == "SOLD/SHIPPING"));
    },
    ...
    displayAttachmentsWarning : function(component, persistent) {
        ...
        var cid = component.get("v.facadeId");
        var attachments = component.get("v.attachments");
